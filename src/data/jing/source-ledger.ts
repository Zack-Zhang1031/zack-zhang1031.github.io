...
export const sourceLedger: readonly SourceRecord[] = [
  ...
  verified({
    id: 'image-luzu',
    section: 'figures',
    title: '吕洞宾与莲花精（佚名中国画，大都会艺术博物馆藏 13.220.112）',
    url: 'https://commons.wikimedia.org/wiki/File:Anonymous_-_Lu_Dong_Bin_and_the_Spirit_of_the_Lotus_-_13.220.112_-_Metropolitan_Museum_of_Art.jpg',
    attribution: '佚名；大都会艺术博物馆藏品 13.220.112',
    license: 'CC0 1.0 / 公有领域',
    retrievedAt: '2026-08-31',
    version: 'commons-2026-08-31-webp',
    checksum: 'sha256:755356ffe44b5c7c7ed604fb62e1e504532e1514fd893f989b52472fc9894e17',
    localTarget: 'public/jing/images/luzu.webp',
  }),
  verified({
    id: 'image-guandi',
    section: 'figures',
    title: '关羽画像（佚名，约 1700，大都会艺术博物馆藏 2001.442）',
    url: 'https://commons.wikimedia.org/wiki/File:Anonymous_-_Guan_Yu_-_2001.442_-_Metropolitan_Museum_of_Art.jpg',
    attribution: '佚名；大都会艺术博物馆藏品 2001.442',
    license: 'CC0 1.0 / 公有领域',
    retrievedAt: '2026-08-31',
    version: 'commons-2026-08-31-webp1400',
    checksum: 'sha256:408874aa11ee45441aed659b8967ecfbcf99a56efa7726368fd0a62c87ff7b08',
    localTarget: 'public/jing/images/guandi.webp',
  }),
  ...
  verified({
    id: 'audio-lot-shake',
    section: 'audio',
    title: '签筒摇签颗粒声（Rainstick.ogg 实录截取、均衡与淡出）',
    url: 'https://commons.wikimedia.org/wiki/File:Rainstick.ogg',
    attribution: 'BambooBeast；本站截取并作响度与频段整理',
    license: '公有领域',
    retrievedAt: '2026-09-01',
    version: 'commons-pd-2026-09-01-mp3-2.55s',
    checksum: 'sha256:6f9be9cc7952947d84fcb5d918aacf3382dc1eedd4661873e792b0d2ef6693e8',
    localTarget: 'public/jing/audio/shake-sticks.mp3',
  }),
  verified({
    id: 'audio-coins-toss',
    section: 'audio',
    title: '铜钱落木面（Coins dropped on wooden floor.ogg 实录截取、均衡与淡出）',
    url: 'https://commons.wikimedia.org/wiki/File:Coins_dropped_on_wooden_floor.ogg',
    attribution: 'Ezwa；本站截取并作响度与频段整理',
    license: '公有领域',
    retrievedAt: '2026-09-01',
    version: 'commons-pd-2026-09-01-mp3-1.9s',
    checksum: 'sha256:53d7c1c7062006e8e16cab1a356b8e8a649465ca545446cde8a27277f7f09d9f',
    localTarget: 'public/jing/audio/coins-toss.mp3',
  }),
  verified({
    id: 'audio-chime',
    section: 'audio',
